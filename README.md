...
* **Clasificación**: Un Perceptrón Multicapa (**MLP**) integrado que utiliza las características optimizadas para categorizar con alta precisión los diferentes tipos de ataques.
